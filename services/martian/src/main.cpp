...
/*
TODO:
1. Добавить логику и обработчики пользовательского интерфейса
2. Добавить механику рейдов
3. Добавить случайный лут с паролем (создать унаследованный от Item класс с методом unlock)
*/
