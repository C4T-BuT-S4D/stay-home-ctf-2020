...
/*
TODO:
0. Протестировать генерацию кода для третьего рейда
1. Убрать отладочные выводы
2. Протестировать руками все менюшки (на сколько это возможно)
3. Написать эксплоит на обе уязвимости
4. Написать чекер
*/
